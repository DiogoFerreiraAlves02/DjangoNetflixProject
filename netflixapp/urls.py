...
from .views import Home, MovieDetail, ProfileList, ProfileCreate, MovieList, PlayMovie, PlayMovieLow
...
urlpatterns = [
    ...
    path('watch/playlow/<str:movie_id>/', PlayMovieLow.as_view(), name="play-movie-low"),
]